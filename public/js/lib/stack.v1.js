function stack() {
  ...
  function addScript(pathToSlides, i) {
    var script = document.createElement( 'script' );
    script.setAttribute( 'src', pathToSlides+i+'.js' );
  ...
  function initialize(d, i) {
    ...
    this.setAttribute('id', 'slide'+this.__stack__.index);
    try {
      addScript('js/sketches/slide', this.__stack__.index);
    } finally {

    }
    console.log(this);
    console.log(this.__stack__.index);
  }
